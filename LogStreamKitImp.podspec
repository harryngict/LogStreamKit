Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
                       TBD
                       DESC
  spec.homepage     = "git@github.com:harryngict/LogStreamKit.git"
  spec.source      = {
  ...
  spec.source_files = "Sources/LogStreamKit/implementation/src/**/*.{swift}"
  spec.dependency 'LogStreamKit'
  
  spec.test_spec 'UnitTests' do |unit_tests|
    unit_tests.scheme = { :code_coverage => true }
    unit_tests.requires_app_host = true
    unit_tests.source_files = 'Sources/LogStreamKit/implementation/Tests/**/*.{swift,h}'
    unit_tests.frameworks = ['XCTest']
    unit_tests.dependency 'LogStreamKitMock'
   end
end
